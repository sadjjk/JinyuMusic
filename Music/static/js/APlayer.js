            ...
            e.exports = function (e) {
                ...
                return n(a, function (e, n) {
                    t += '\n<li onmouseover="showPlayerSongDel(this)" >\n    <span class="aplayer-list-cur" style="background-color: ',
                        ...
                        t += r(e.artist),
                        t += '</span>\n <span class="icon li-add ng-hide" onclick="addMyPlaylistDialog(\'player\',event)" style="position: absolute;left: 90%;top: 50%;transform: translate(-50%, -50%)"></span>',
                        t += '</span>\n <span class="icon li-del ng-hide" onclick="removePlayerSong(this,event)" style="position: absolute;left: 95%;top: 50%;transform: translate(-50%, -50%)"></span>',
                        t += "</span>\n</li>\n"
                ...
                return i(e, [{
                    ...
                    value: function () {
                        ...
                        this.player.lrc && this.player.lrc.clear(),
                            ...
                            this.player.template.title.innerHTML = "暂无歌曲",
            ...
            var s = function () {
                ...
                return a(e, [{
                    ...
                    value: async function (e) {
                        ...
                        // 实时请求歌词
                        const params = {
                            'platform': this.player.list.audios[e].platform,
                            'song_id': this.player.list.audios[e].song_id
                        }

                        const lyricFun = () => new Promise(resolve => {
                            $.get('/api/v1/song_lyric', params, function (resp) {
                                resolve(resp.data.lyric)
                            })
                        });
                        this.player.list.audios[e].lrc = await lyricFun();

                        // 保存正在播放的歌曲索引
                        localStorage.setItem('curPlayingSong', JSON.stringify({
                            'song_id': this.player.list.audios[e].song_id,
                            'platform': this.player.list.audios[e].platform
                        }));

                        // 修改标题
                        $('title').text('❚❚ ' + this.player.list.audios[e].name + ' - ' + this.player.list.audios[e].artist);

                        showSongDetailDialog(0);
                        ...
                        if (!this.parsed[e])
                            if (this.async) {
                                ...
                                this.player.list.audios[e].lrc ? this.parsed[e] = this.parse(this.player.list.audios[e].lrc) : this.parsed[e] = [["00:00", "暂无歌词!"]];
        ...
        , function (e, t, n) {
            ...
            e.exports = function (e) {
                ...
                r && (t += "background-image: url(&quot;",
                    ...
                    t += s.right,
                    t += '</button></div>\n</div>\n<div class="aplayer-lrc" onclick="showSongDetailDialog()">\n    <div class="aplayer-lrc-contents" style="transform: translateY(0); -webkit-transform: translateY(0);"></div>\n</div>\n') : (t += '\n<div class="aplayer-body">\n    <div class="aplayer-pic" style="',
                r && (t += "background-image: url(&quot;",
                    t += o(r),
                    t += "&quot;);"),
                    t += "background-color: ",
                    ...
                    t += ';">\n        <div class="aplayer-button aplayer-play">',
                    t += s.play,
                    t += '</div>\n    </div>\n    <div class="aplayer-info">\n        <div class="aplayer-music">\n            <span class="aplayer-title" onclick="showSongDetailDialog()">暂无歌曲</span>\n            <span class="aplayer-author"></span>\n        </div>\n        <div class="aplayer-lrc" onclick="showSongDetailDialog()">\n            <div class="aplayer-lrc-contents" style="transform: translateY(0); -webkit-transform: translateY(0);"></div>\n        </div>\n        <div class="aplayer-controller">\n            <div class="aplayer-bar-wrap">\n                <div class="aplayer-bar">\n                    <div class="aplayer-loaded" style="width: 0"></div>\n                    <div class="aplayer-played" style="width: 0; background: ',
                    t += o(a.theme),
                    t += ';">\n                        <span class="aplayer-thumb" style="background: ',
                    t += o(a.theme),
                    t += ';">\n                            <span class="aplayer-loading-icon">',
            ...
            var m = []
                ...
                return i(e, [{
                    ...
                    value: async function (e) {
                        ...
                        const urlFun = () => new Promise(resolve => {
                            $.get('/api/v1/song_play_url', params, function (resp) {
                    ...
                    value: function () {
                        ...
                        this.mode = e,
                            "mini" === e ? this.container.classList.remove("aplayer-narrow") : "normal" === e && this.container.classList.add("aplayer-narrow")
                    }
                }, {
                    key: "notice",
                    value: function (e) {
